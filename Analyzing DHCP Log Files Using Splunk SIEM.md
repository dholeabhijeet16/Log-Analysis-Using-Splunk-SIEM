...
## Project Overview
In this project, we will upload  DHCP log files to Splunk SIEM and perform various analyses to gain insights into IP address assignment within the network.
...
### 3. Choose File
- Click on **Select File** and choose the  DHCP log file you prepared earlier.
...
```
index=<dhcp_index> sourcetype=<dhcp_logs>
```
